<?php
   ...
   //   				data-ad-slot=\"7469889246\"></ins>
		...
		echo "<div id=\"general_search_section\">";
			...
			//if($start < 90) {
				echo "<div id=\"forward_back\"><span><a id=\"prev_page\" href=\"/adult/results.php?q={$query}&start={$prevPage}\">Previous</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}\">1</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=10\">2</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=20\">3</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=30\">4</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=40\">5</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=50\">6</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=60\">7</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=70\">8</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=80\">9</a></span>
					<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=90\">10</a></span>
					<span><a id=\"next_page\" href=\"/adult/results.php?q={$query}&start={$pageNext}\">Next</a></span></div>";
			//} else {
			//	echo "<div id=\"forward_back\"><span><a id=\"prev_page\" href=\"/adult/results.php?q={$query}&start={$prevPage}\">Previous</a></span>";
			//	$tempStart = urlencode($start - 50);
			//	$pageNum = urlencode(($tempStart+10) / 10);
			//	for ($i=0; $i < 5; $i++) { 
			//		echo "<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start={$tempStart}\">{$pageNum}</a></span>";
			//		$tempStart = urlencode($tempStart + 10);
			//		$pageNum = urlencode($pageNum + 1);
			//	}
			//	//echo "<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start=$start\"></a></span>";
			//	// Holds the start value
			//	$tempStart = urlencode($start + 10);
			//	$pageNum = urlencode(($tempStart+10) / 10);
			//	// Do the next 5 page numbers from the current ones
			//	for($i=0; $i < 5; $i++) { 
			//		echo "<span><a id=\"page\" href=\"/adult/results.php?q={$query}&start={$tempStart}\">{$pageNum}</a></span>";
			//		$tempStart = urlencode($tempStart + 10);
			//		$pageNum = urlencode($pageNum + 1);
			//	}
			//	echo "<span><a id=\"next_page\" href=\"/adult/results.php?q={$query}&start={$pageNext}\">Next</a></span></div>";
			//}
